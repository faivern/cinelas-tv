...
namespace backend.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        [HttpGet("tv/{seriesId}/season/{seasonNumber:int}")]
        public async Task<IActionResult> GetShowSeason(int seriesId, int seasonNumber)
        {
            var data = await _tmdbService.GetShowSeasonAsync(seriesId, seasonNumber);
            return Content(data, "application/json");
        }
