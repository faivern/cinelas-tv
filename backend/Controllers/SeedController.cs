...
namespace backend.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // Favorites with full ratings + reviews
            new SeedEntryDef(27205,  MediaTypes.Movie, WatchStatus.Favorites, 9.0, 9.5, 9.5, 9.0, 1,
                "A masterclass in layered storytelling. Nolan weaves dream logic into a heist thriller that rewards every rewatch."),
            new SeedEntryDef(157336, MediaTypes.Movie, WatchStatus.Favorites, 8.5, 9.0, 10.0, 9.5, 1,
                "Hans Zimmer's organ score alone is worth the price of admission. The docking scene is peak cinema."),
            new SeedEntryDef(603,    MediaTypes.Movie, WatchStatus.Favorites, 8.0, 9.0, 8.5, 9.0, 2,
                "Still holds up. The philosophical underpinnings elevate what could have been a simple action movie."),
            new SeedEntryDef(278,    MediaTypes.Movie, WatchStatus.Favorites, 10.0, 10.0, 8.5, 8.0, 6,
                "The definitive prison drama. Tim Robbins and Morgan Freeman deliver career-best performances."),
            new SeedEntryDef(238,    MediaTypes.Movie, WatchStatus.Favorites, 10.0, 10.0, 9.0, 9.0, 7,
                "The definitive crime saga."),
            new SeedEntryDef(680,    MediaTypes.Movie, WatchStatus.Favorites, 9.5, 9.5, 9.0, 8.5, 3, null),
            new SeedEntryDef(550,    MediaTypes.Movie, WatchStatus.Favorites, 9.0, 8.5, 8.0, 8.0, 4, null),
            new SeedEntryDef(496243, MediaTypes.Movie, WatchStatus.Favorites, 9.5, 10.0, 8.5, 9.0, 2,
                "Bong Joon-ho crafted a genre-defying film. The tonal shifts between comedy and horror are seamless."),
            new SeedEntryDef(545611, MediaTypes.Movie, WatchStatus.Favorites, 9.0, 9.5, 8.0, 9.5, 1,
                "Somehow makes the multiverse feel deeply personal. Michelle Yeoh deserved every award."),
            new SeedEntryDef(244786, MediaTypes.Movie, WatchStatus.Favorites, 9.5, 8.5, 10.0, 8.0, 3,
                "J.K. Simmons is terrifying. The final drum solo is one of the most intense sequences ever filmed."),
            new SeedEntryDef(335984, MediaTypes.Movie, WatchStatus.Favorites, 8.0, 8.5, 9.5, 10.0, 3, null),
            new SeedEntryDef(438631, MediaTypes.Movie, WatchStatus.Favorites, 8.5, 8.0, 9.0, 10.0, 4, null),
            new SeedEntryDef(329865, MediaTypes.Movie, WatchStatus.Favorites, 8.5, 9.5, 8.0, 8.5, 5, null),
            new SeedEntryDef(419430, MediaTypes.Movie, WatchStatus.Favorites, 9.0, 9.0, 7.5, 8.0, 2,
                "Jordan Peele turned social commentary into genuine horror. A landmark debut."),
            new SeedEntryDef(76341,  MediaTypes.Movie, WatchStatus.Favorites, 8.0, 7.5, 8.5, 10.0, 1, null),

            // Favorites with partial ratings (no soundtrack)
            new SeedEntryDef(6977,  MediaTypes.Movie, WatchStatus.Favorites, 9.0, 9.5, null, 9.0, 5, null),
            new SeedEntryDef(7345,  MediaTypes.Movie, WatchStatus.Favorites, 10.0, 9.0, null, 9.5, 8,
        ...
        public async Task<IActionResult> Seed()
        {
            ...
            try
            {
                ...
                foreach (var def in entryDefs)
                {
                    ...
                    var watchedAt = def.Status == WatchStatus.Favorites
