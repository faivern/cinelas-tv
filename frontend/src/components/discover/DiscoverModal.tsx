                    ...
                    <div className="flex-1 flex flex-col overflow-hidden">
                      ...
                      <div className="p-4">
                        <div className="relative">
                          <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-subtle" />
                          <input
                            type="text"
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            placeholder="Search movies and TV shows..."
                            className="w-full pl-10 pr-4 py-2.5 bg-input border border-outline rounded-lg text-text-h1 placeholder-subtle    "
                            onFocus={(e) => {
