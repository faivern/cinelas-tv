...
export default function GenreCheckboxList({
  ...
  return (
    <Popover className="relative">
      {({ open }) => (
        <>
          <Popover.Button className="relative w-full cursor-pointer rounded-lg bg-action-primary border border-outline py-2 pl-3 pr-10 text-left text-text-h1     transition-all text-sm">
          ...
          >
            <Popover.Panel className="absolute z-20 mt-1 w-full max-h-64 overflow-auto rounded-lg bg-component-primary border border-outline px-1 py-1 shadow-lg ">
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="h-5 w-5 rounded border-outline bg-action-primary text-accent-primary  "
                    />
