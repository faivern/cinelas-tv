...
const avgRating = calculateAverageRating(item);
  ...
  const cardClass = isEditMode
    ? "focus-ring-within bg-[var(--component-primary)] rounded-2xl border border-[var(--border)] overflow-hidden shadow-lg hover:shadow-xl hover:border-accent-primary/75 transition-all duration-300 relative"
    : "focus-ring-within bg-[var(--component-primary)] rounded-2xl border border-[var(--border)] overflow-hidden shadow-lg hover:shadow-xl sm:hover:scale-105 hover:border-accent-primary/75 transition-all duration-300 relative";
