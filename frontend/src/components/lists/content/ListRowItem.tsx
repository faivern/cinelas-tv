...
export default function ListRowItem({
  ...
  return (
    <div
      ...
      role={hasExpandableContent && !isEditMode ? "button" : undefined}
      tabIndex={hasExpandableContent && !isEditMode ? 0 : undefined}
      aria-expanded={hasExpandableContent && !isEditMode ? isExpanded : undefined}
      onKeyDown={
        hasExpandableContent && !isEditMode
          ? (e) => {
      ...
      className={`focus-ring-within group relative flex flex-col gap-2 p-3 rounded-xl overflow-hidden shadow-lg border border-[var(--border)]/40 transition-all duration-300
            ...
            <div className="overflow-hidden">
              <div className="ml-20 pt-2 pb-1 space-y-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {avgRating !== null && (
                    <div className="flex items-center gap-1 text-sm">
                      <Star className="text-accent-primary size-3" />
                      <span className="text-[var(--subtle)]">
                        {avgRating.toFixed(1)}
                      </span>
