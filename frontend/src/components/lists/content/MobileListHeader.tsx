        ...
        <Listbox value={sortOption} onChange={onSortChange}>
          <div className="relative">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute right-0 z-[60] mt-1 w-40 overflow-auto rounded-lg bg-[var(--action-primary)] border border-[var(--border)] px-1 py-1 text-sm shadow-lg ">
