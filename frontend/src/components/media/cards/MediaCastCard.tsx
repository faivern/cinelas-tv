  ...
  return (
    <div className="flex flex-col items-center w-full text-center">
      {castId ? (
        ...
        >
          <div className="focus-ring-target w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full overflow-hidden shadow-sm flex items-center justify-center hover:scale-105 transition-transform duration-200 cursor-pointer">
            {profileImage}
          </div>
