          ...
          >
            <div className="relative">
              <img
                ...
                className="w-12 h-12 rounded-xl object-cover border-2 border-gray-700 transition-all shadow-md"
              />
            </div>
...
export default function WatchProviders({ mediaType, mediaId }: Props) {
  ...
  const { data: providersData, isLoading: providersLoading } =
    useWatchProviders(mediaType, mediaId);
        ...
        {regionsLoading ? (
          ...
          <Listbox value={selectedCountry} onChange={setSelectedCountry}>
            <div className="relative w-full sm:w-48">
              <Listbox.Button className="relative w-full cursor-pointer rounded-lg bg-gray-800 border border-gray-600 py-2 pl-3 pr-10 text-left text-white     transition-all text-sm">
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Listbox.Options className="absolute z-20 mt-1 max-h-72 w-full overflow-hidden rounded-lg bg-gray-800 border border-gray-600 text-sm shadow-lg ">
                  <div className="sticky top-0 bg-gray-800 p-2 border-b border-gray-700">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-700 border border-gray-600 rounded-md py-1.5 pl-8 pr-3 text-white placeholder-gray-400   text-sm"
