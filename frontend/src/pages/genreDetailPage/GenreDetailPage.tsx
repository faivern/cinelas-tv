...
import TvGenreDetailPage from "./TvGenreDetailPage";

export default function GenreDetailPage() {
  if (isTvMode()) return <TvGenreDetailPage />;
  return <WebGenreDetailPage />;
}

function WebGenreDetailPage() {
  ...
  const genreIdNum = useMemo(() => {
    ...
    // TV-split ids (e.g. links built from raw genre_ids) map to the merged genre
