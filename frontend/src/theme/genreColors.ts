export const GENRE_COLORS: Record<number, string> = {
    ...
    878: "bg-gradient-to-br from-cyan-200/80 via-teal-300/80 to-indigo-400/80 ring-teal-300/60", // Sci-Fi
    ...
    10759: "bg-gradient-to-br from-orange-200/80 via-red-300/80 to-rose-400/80 ring-red-300/60", // Action (TV, folds into 28)
    ...
    10765: "bg-gradient-to-br from-cyan-200/80 via-indigo-300/80 to-violet-400/80 ring-indigo-300/60", // Sci-Fi (TV, folds into 878)
