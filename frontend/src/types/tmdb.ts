...
// A season entry as it appears in the TV `details.seasons` array.
...
export type Credit = {
  ...
  department?: string;
  order?: number;
  // TMDB tv/{id}/aggregate_credits shape — flattened into character/job by
  // getMediaCredits, but jobs[] is kept so grouping can match individual jobs.
